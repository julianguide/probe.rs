...
{/* Too large for optimized by Sharp with <Image>? 🙄 */}
<center><img src={intro_and_rtt.src} alt="update" style="margin-top: 1em; margin-bottom: 1em; max-width:100%; max-height:100%; width: auto; height: auto;"  /></center>
...
<center><Image src={variable_set_value} alt="update" style="margin-top: 1em; margin-bottom: 1em; max-width:100%; max-height:100%; width: auto; height: auto;" /></center>
...
{/* Too large for optimized by Sharp with <Image>? 🙄 */}
<center><img src={variable_edit_and_watch.src} alt="update" style="margin-top: 1em; margin-bottom: 1em; max-width:100%; max-height:100%; width: auto; height: auto;" /></center>
...
<center><Image src={disassemble_and_instruction_breakpoint} alt="update" style="margin-top: 1em; margin-bottom: 1em; max-width:100%; max-height:100%; width: auto; height: auto;" /></center>
...
{/* Too large for optimized by Sharp with <Image>? 🙄 */}
<center><img src={SVD.src} alt="update" style="margin-top: 1em; margin-bottom: 1em; max-width:100%; max-height:100%; width: auto; height: auto;" /></center>
